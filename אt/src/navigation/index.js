...
//IMPORT SCREENS
import Greeting, {greetingScreenOptions} from '../screens/Trivia/Greeting';
...
export const TriviaStack = () => {
    return(
        <TriviaStackNavigator.Navigator>
            <TriviaStackNavigator.Screen name = 'greeting' component = {Greeting} options = {greetingScreenOptions}/>
